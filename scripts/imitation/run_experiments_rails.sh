...
python multiagent_curriculum_training.py --exp_name multiagent_rails_col_off_2000_1_{} --reward_handler_use_env_rewards True &

python multiagent_curriculum_training.py --exp_name multiagent_rails_col_off_2000_2_{} --reward_handler_use_env_rewards True &

python multiagent_curriculum_training.py --exp_name multiagent_rails_col_off_2000_3_{} --reward_handler_use_env_rewards True &
